...
QT_MOC_LITERAL(1, 7, 11), // "pacmanMoved"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 11) // "newPosition"

    },
    "PacMan\0pacmanMoved\0\0newPosition"
};
...
void PacMan::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->pacmanMoved((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PacMan::*)(QPointF );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PacMan::pacmanMoved)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PacMan::pacmanMoved(QPointF _t1)
{
